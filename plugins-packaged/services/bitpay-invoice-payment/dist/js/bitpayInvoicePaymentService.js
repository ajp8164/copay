...
angular.module('bitpayInvoicePaymentApp', [
	'ngLodash',
	'copayPluginClient',
  'bitpayInvoicePaymentApp'
]);

'use strict';

angular.module('bitpayInvoicePaymentApp').factory('AbstractPaymentService', function ($log, $http, CWallet) {
...
angular.module('bitpayInvoicePaymentApp').factory('CBitPayInvoicePaymentService', function (AbstractPaymentService, $rootScope, $log, gettext, CPlugin) {
   ...
   * TODO
   *
  CBitPayInvoicePaymentService.prototype.setNotification = function() {
