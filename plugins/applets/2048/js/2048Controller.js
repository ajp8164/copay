...
angular.module('copayApp.plugins').controller('2048Controller', function($rootScope, $timeout, CContext, GameManager, KeyboardInputManager, HTMLActuator) {
