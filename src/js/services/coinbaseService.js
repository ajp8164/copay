...
angular.module('copayApp.services').factory('coinbaseService', function($http, $log, isCordova, lodash, storageService, configService, brand) {
  var root = {};
  var credentials = {};
  ...
  root.setCredentials = function(network) {
    ...
    if (network == 'testnet') {
      ...
      credentials.CLIENT_ID = brand.features.coinbase.auth.clientId;
      credentials.CLIENT_SECRET = brand.features.coinbase.auth.clientSecret;
    };
  };
