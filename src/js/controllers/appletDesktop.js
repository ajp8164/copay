...
angular.module('copayApp.controllers').controller('appletDesktopController', function($scope, $rootScope, $log, $ionicSlideBoxDelegate, lodash, appletService, appletCatalogService, FocusedWallet, Constants, isMobile, isCordova) {
  ...
  function saveAppletState(applets) {
    ...
    appletService.updateAppletState(applets, {
      layout: Constants.LAYOUT_DESKTOP
    });
  };
